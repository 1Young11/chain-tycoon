...
export const equipmentMock: EquipmentInstance[] = [
   ...
   },
   {
      ...
      cardMetrics: [{ label: 'Hashrate', value: '60 MH/s' }, { label: 'Power', value: '160 W' }],
   ...
   },
   {
      ...
      cardMetrics: [{ label: 'Hashrate', value: '0 MH/s' }, { label: 'Power', value: '0 W' }],
   ...
   },
   {
      ...
      cardMetrics: [{ label: 'Max Output', value: '850 W' }, { label: 'Efficiency', value: 'Gold' }], performance: [], imageUrl: null,
   },
   {
      ...
      purchasePriceUsd: 315, currentValueUsd: 210, lifetimeRevenueUsd: 0, runtimeHours: 630, repairEtaMinutes: 160, powerWatts: null,
      cardMetrics: [{ label: 'Max Output', value: '1200 W' }, { label: 'Efficiency', value: 'Platinum' }], performance: [], imageUrl: null,
   },
   {
      ...
      cardMetrics: [{ label: 'GPU Slots', value: '6' }, { label: 'Power', value: '70 W' }], performance: [], imageUrl: null,
   },
   {
